...
- `basemap_subduction_0Ma.png` — same basemap/extent as `basemap_0Ma.png`, but with only the subduction-zone line drawn (no ridges/transforms), for Notebook 3's earthquake/subduction-zone comparison
